...
<template>
  <v-card class="animate-in animate-delay-5">
    <v-card-title class="seat-map-title pa-5 pb-3"> Seat Map </v-card-title>
    <v-divider />
    <v-card-text class="pa-5">
      ...
      <div class="seat-grid">
        ...
        <div v-for="rowCode in SEAT_ROWS" :key="rowCode" class="seat-row">
          ...
          <div class="seat-row-list">
            ...
            >
              <template #activator="{ props: tooltipProps }">
                <button v-bind="tooltipProps" class="seat-item" type="button">
                  <span
